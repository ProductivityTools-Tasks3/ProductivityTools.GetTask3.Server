...
namespace ProductivityTools.GetTask3.App.Queries.Tests
{
    ...
    public class Queries
    {
        ...
        public void GetList()
        {
            ...
            Domain.Element elementLevel1 = new Domain.Element("Level1", CoreObjects.ElementType.Task, root.ElementId);
            root.Elements.Add(elementLevel1);
            Domain.Element elementLevel2 = new Domain.Element("Level2", CoreObjects.ElementType.Task, root.ElementId);
